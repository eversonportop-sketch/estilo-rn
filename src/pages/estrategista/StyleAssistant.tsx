    ...
    <div className="flex flex-col h-screen">
      <div className="p-8 pb-0">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground text-sm mb-6">Inteligência artificial para consultoria de imagem</p>
        </motion.div>
      </div>
      ...
      <div className="p-8 pt-4">
        <div className="flex gap-2 mb-3 overflow-x-auto pb-1">
          {suggestedPrompts.map((prompt) => (
            <button
              ...
              className="text-xs px-4 py-2 rounded-full border border-border hover:border-gold/40 whitespace-nowrap transition-colors"
            >
              {prompt}
            </button>
          ))}
        ...
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-xl border border-border bg-card text-sm focus:outline-none focus:ring-1 focus:ring-gold/40"
          />
